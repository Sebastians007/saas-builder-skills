...
### Fed By
- `pricing-model-calculator` (S2-Planning) — price point must exist before a funnel can be chosen
- `prd-writer` (S2-Planning) — defines the offer this funnel will sell
